											...
											<td class="btd" colSpan="9">
												<table cellSpacing="0" cellPadding="3" width="100%" border="0">
													<tr>
														...
														<td align="left" width="139"><FONT face="宋体"></FONT></td>
														<td align="left" width="39">
															<div align="right">登陆名</div>
														</td>
														<td align="left" width="147"><FONT face="宋体"><asp:textbox id="Search_search" runat="server" Width="112px"></asp:textbox></FONT></td>
										...
										<tr class="btd3" align="center">
											<td class="btd"><asp:datagrid id="DataGrid1" runat="server" Width="100%" AllowPaging="True" AllowSorting="True"
													...
													<Columns>
														...
														<asp:BoundColumn DataField="m_member_login" SortExpression="m_member_login" HeaderText="登陆名"></asp:BoundColumn>
														<asp:BoundColumn DataField="name" SortExpression="name" HeaderText="姓名"></asp:BoundColumn>
														<asp:BoundColumn DataField="m_security_level_id" SortExpression="m_security_level_id" HeaderText="用户角色"></asp:BoundColumn>
