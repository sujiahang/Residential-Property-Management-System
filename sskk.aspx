										...
										<tr class="btd2">
											<td class="btd"><asp:datagrid id="DataGrid1" runat="server" PageSize="20" Width="100%" AutoGenerateColumns="False"
													...
													<Columns>
														...
														<asp:BoundColumn DataField="typeName" SortExpression="typeName" HeaderText="类型"></asp:BoundColumn>
														<asp:BoundColumn DataField="MainPerson" SortExpression="MainPerson" HeaderText="负责人"></asp:BoundColumn>
														<asp:BoundColumn DataField="ContactPerson" SortExpression="ContactPerson" HeaderText="联系人"></asp:BoundColumn>
														<asp:BoundColumn DataField="Phone" SortExpression="Phone" HeaderText="联系电话"></asp:BoundColumn>
														<asp:TemplateColumn>
